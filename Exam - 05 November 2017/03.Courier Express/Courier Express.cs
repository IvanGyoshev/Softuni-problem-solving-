...
namespace _03.Courier_Express
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                if (weight < 1) costs = 1.8*0.03d*weight+ 0.03d;
                else if (weight >= 1 && weight <= 10) costs = 1.4*0.05d * weight+ 0.05d;
                else if (weight >= 11 && weight <= 40) costs =  1.05*0.1d*weight+ 0.1d;
                else if (weight >= 41 && weight <= 90) costs = 0.02*0.15d*weight + 0.15d;
                else if (weight >= 91 && weight <= 150) costs = 1.01*0.2d * weight+ 0.2d;
            }
            costs *= distance;
